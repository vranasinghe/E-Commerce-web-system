...
CREATE TABLE "UserSizeProfile" (
    ...
    "fitPreference" TEXT,
    "usualTopSize" TEXT,
    "usualBottomSize" TEXT,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "UserSizeProfile_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "UserSizeProfile_userId_key" ON "UserSizeProfile"("userId");
...
-- AddForeignKey
ALTER TABLE "UserSizeProfile" ADD CONSTRAINT "UserSizeProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
